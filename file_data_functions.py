...
def get_metrics(run_data_df):
    ...
    long_offsets_df = filter_duration(run_data_df)
    ...
    large_offsets_df = filter_value(run_data_df)
...
def filter_duration(dataframe, threshold=config['duration_threshold'], is_max=config['dur_thr_is_max'],
...
def filter_value(dataframe, threshold=config['value_threshold'], is_max=config['val_thr_is_max'],
