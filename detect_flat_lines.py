...
output_flat_line_plots = f'generated_files/detection_removal_processes/flat_lines_plots/{station}'
...
"""Tolerance method for detecting flat and approximately-flat lines."""
window_size = 15
tolerance = 0.002
...
if not os.path.exists(filename):
    flat_df_identical_method.to_csv(filename, index=False)
# End if.
